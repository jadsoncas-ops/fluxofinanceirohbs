      ...
      <div className="flex bg-muted/60 p-1 rounded-xl border border-border/60 shadow-inner">
        {filterTabs.map(tab => (
          <button key={tab.key} onClick={() => onTabChange?.(tab.key)}
            className={`flex-1 flex justify-center items-center gap-1 py-2.5 text-[10px] sm:text-[11px] font-black uppercase tracking-wider sm:tracking-widest rounded-lg transition-all ${
